...
{
	/// <summary>This component allows you to translate the current GameObject using events.</summary>
	public class LeanManualTranslate : MonoBehaviour
	{
		...
		public void TranslateA(float delta)
		{
			Translate(new Vector2(delta, 0.0f));
		}

		public void TranslateB(float delta)
		{
			Translate(new Vector2(0.0f, delta));
		}
