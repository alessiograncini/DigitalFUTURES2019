...
{
	/// <summary>This component allows you to move a GameObject (e.g. camera) between the Distance Min/Max values, allowing you to zoom in out without adjusting the FOV.</summary>
	[ExecuteInEditMode]
	public class LeanCameraDolly : MonoBehaviour
	{
		...
		/// <summary>This method allows you to manually adjust the dolly distance externally.</summary>
