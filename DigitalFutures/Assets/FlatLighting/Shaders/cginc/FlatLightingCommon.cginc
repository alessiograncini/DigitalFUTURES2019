...
inline half4 FLfragment(fl_vertex2fragment i) {
	...
	#ifdef FL_SPOT_LIGHT
		half4 spotLight = spot_light(i.flWorldVertex, i.flWorldNormal);
		light += spotLight;
	#endif

	#ifdef FL_POINT_LIGHT
		half4 pointLight = point_light(i.flWorldVertex, i.flWorldNormal);
	...
	#if defined(FL_ALPHA)
		result.a = axisAlpha * gradientAlpha * _Alpha;
	#endif
	return result;
}
