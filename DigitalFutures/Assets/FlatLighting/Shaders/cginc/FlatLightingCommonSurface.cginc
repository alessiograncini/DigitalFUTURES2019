...
void surf (Input IN, inout SurfaceOutput o) {
	...
	fixed axisAlpha = flatLight.a;
	fixed gradientAlpha = 1.0f;
	...
	o.Alpha = axisAlpha * gradientAlpha;
}
...
//			Above is the branch version
		half NdotL_with_cuts = (int)(_CelDivisions >= 4) * (((int)(NdotL >= 0.75) * 1) + 
								((int)(NdotL < 0.75 && NdotL >= 0.5) * 0.75) + 
								((int)(NdotL < 0.5 && NdotL >= 0.25) * 0.5) + 
								((int)(NdotL < 0.25 && NdotL >= 0.005) * 0.25) + 
								((int)(NdotL < 0.005) * 0.0));

		NdotL_with_cuts += (int)(_CelDivisions == 3) * (((int)(NdotL >= 0.5) * 0.75) + 
								((int)(NdotL < 0.5 && NdotL >= 0.25) * 0.5) + 
								((int)(NdotL < 0.25 && NdotL >= 0.005) * 0.25) + 
								((int)(NdotL < 0.005) * 0.0));

		NdotL_with_cuts += (int)(_CelDivisions == 2) * (((int)(NdotL >= 0.25) * 0.5) + 
								((int)(NdotL < 0.25 && NdotL >= 0.005) * 0.25) + 
								((int)(NdotL < 0.005) * 0.0));

		NdotL_with_cuts += (int)(_CelDivisions == 1) * ((int)(NdotL >= 0.005) * 0.4);
