...
namespace FlatLighting {
	public static class Labels  {
		...
		public static GUIContent UseMainTexture = new GUIContent("Use Texture", "Apply texture on top of the colors.");
		...
		public static string TexturePower = "Texture Power";
		...
		public static GUIContent Water = new GUIContent("Water", "The water settings.");

		public static GUIContent CelThreshold = new GUIContent("Cel Threshold");
		public static GUIContent CelDivisions = new GUIContent("Cel Divisions");
